...
<body>
	...
	<r:override name="navbar">
		<li class="nav-item"><a class="nav-link scrollto"
			href="Ajouter_Intervention">Ajouter Intervention</a></li>
		<li class="nav-item"><a class="nav-link scrollto"
			href="Liste_Intervention">Liste des intervention</a></li>
			...
			<section class="mt-5 mb-0 p-0 h-auto" id="content">
				<div class="d-flex align-content-start row px-5 pb-0 h-auto">
					<r:block name="content">
						<div class="col">
							<img alt="" src="assets/img/technicien.svg" class="img-decorate" width="580">
						</div>
						<div class="col mt-5">
