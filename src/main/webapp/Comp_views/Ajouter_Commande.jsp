	...
	<div class="container px-200 mt-2">
		<form class="mx-5"
			...
			<div class="mb-3 d-flex justify-content-end" id="button">
				<button name="button" type="button" id="ajouter" class="btn rounded-pill btn-outline-PastelPink me-2">ajouter</button>
				<button name="submit" type="submit" class="btn rounded-pill btn-outline-Dark-Cornflower-bleu">Confirmer</button>
			</div>
